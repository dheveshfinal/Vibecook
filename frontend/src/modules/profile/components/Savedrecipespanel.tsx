...
const SavedRecipesPanel: React.FC = () => {
    ...
    React.useEffect(() => {
        if (profile?.id) {
            setLoading(true);
            profileService.getSavedRecipes(profile.id)
    ...
    const displayRecipes = filter === "all" ? savedRecipes : savedRecipes.filter((r) => {
        // Simple heuristic for "customized" vs "saved"
        const isCustom = r.note || r.customized_at;
        ...
        <div style={styles.card}>
            ...
            <div style={styles.list}>
                {displayRecipes.length === 0 ? (
                    ...
                    const isCustom = recipe.note || recipe.customized_at;
                    return (
